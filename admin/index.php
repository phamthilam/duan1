...
if((isset($_GET['act']))&&($_GET['act']!="")){
    ...
    switch ($act){
        ...
        case 'addpttt':
            if(isset($_POST['themmoi'])&&($_POST['themmoi'])){
                $pttt=$_POST['pttt'];
                $sql="insert into phuongthuctt (pttt) values ('$pttt')";
                pdo_execute($sql);
                $thongbao="Thêm mới thành công";
            }
            include "phuongthuctt/add.php";  

        break;
        case 'addtrangthaidh':
            if(isset($_POST['themmoi'])&&($_POST['themmoi'])){
                $trangthai=$_POST['trangthai'];
                $sql="insert into trangthaidh (trangthai) values ('$trangthai')";
                pdo_execute($sql);
                $thongbao="Thêm mới thành công";
            }
            include "trangthaidathang/add.php";  
