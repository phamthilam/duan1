...
<body >
    <div class="khung addleft ">
    <div class="tieude">
        <h2 class="adm">Thêm mới sản phẩm</h2>
    </div>
    <form action="index.php?act=addsp" method="post" enctype="multipart/form-data" class="">
        ...
        <select name="idloai" id="" class="form-select">
           ...
           <input type="submit" value="Thêm sản phẩm" name="themsp" class="nhap">
