<form action="index.php?act=addspbt" method="post" enctype="multipart/form-data" class="khung addleft">
<div class="tieude">
        <h2 class="adm">Thêm mới biến thể</h2>
    </div>
<select name="masp" id="" class="form-select">
        ...
        <input type="submit" value="Thêm sản phẩm" name="themspbt" class="nhap">
        </form>