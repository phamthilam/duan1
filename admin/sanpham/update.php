...
<body>
    <form action="index.php?act=updatesp" method="post" enctype="multipart/form-data" class="khung addleftsp">
    <div class="tieude">
        <h2 class="adm">Cập nhật sản phẩm</h2>
    </div>
        ...
        <input type="hidden" name="id_bt" value=<?php echo $sp['id_bt']?>>
           <input type="submit" value="Cập nhật sản phẩm" name="capnhatsp" class="nhap" >
           <a href="index.php?act=listsp"><input type="button" value="danh sách" class="nhap"></a>
    </form>
</body>
</html>