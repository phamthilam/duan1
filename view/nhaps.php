                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="coupon">
                            ...
                            <input type="text" name="name_magg" placeholder="Mã giảm giá">
                            <input type="submit" name="apdungma" value="Áp dụng mã">
                        ...
                        <div class="cart-content">
                         ...
                         <h3>Chi tiết giỏ hàng</h3>
                                ...
                                if (isset($_POST['apdungma']) && ($_POST['apdungma'])) {
                                 ...
                                 foreach ($_SESSION['giohang'] as $item){
                                    $pvc=$tong+100000;
                                    if(isset($checkmagg['giamgia'])){$tt=$pvc-$checkmagg['giamgia'];}
                                    echo'
